...
(function ($) {
  ...
  if (!String.prototype.includesString) {
    (function () {
      ...
      var indexOf = ''.indexOf;
      var includesString = function (search) {
        if (this == null) {
          throw new TypeError();
        }
      ...
      if (defineProperty) {
        defineProperty(String.prototype, 'includesString', {
          'value': includesString,
          'configurable': true,
          'writable': true
        });
      } else {
        String.prototype.includesString = includesString;
      }
    }());
  }
  ...
  $.expr.pseudos.icontains = function (obj, index, meta) {
    ...
    return haystack.includesString(meta[3].toUpperCase());
  };
